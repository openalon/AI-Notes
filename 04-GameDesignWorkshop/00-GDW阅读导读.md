...
**这不是一本教你「想出好点子」的书，而是一本教你怎么用试玩，把点子改到真正符合你事先写下的玩家体验目标的书。** 三版到五版方法没换，换的是时代语境。

## 一张图看懂

```mermaid
flowchart TD
  G[Player experience goals] --> I[Ideation]
  I --> P[Physical prototype]
  P --> D[Digital prototype]
  D --> T[Playtest]
  T --> E[Evaluate against goals]
  E -->|还没达到目标，回去改| I
  E -->|达到目标，进入制作| Prod[制作阶段，仍继续小迭代]
```
